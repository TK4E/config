...
function! ElelineBufnrWinnr() abort
  ...
  "if !s:gui
    ...
    "let l:bufnr = l:bufnr > 20 ? l:bufnr : nr2char(l:bufnr).' '
  "endif
...
function! s:out_cb(channel, message) abort
  if a:message =~# '^* '
    ...
    if !ha_key(s:jobs, l:job_id) | return | endif
...
function! s:StatusLine() abort
  ...
  let l:common = l:curfname.l:branch.l:status.l:time.l:error.l:warning.l:tags.l:lcn.l:coc.l:vista
  ...
  let l:pos = '%#Eleline8# '.(s:font?"\ue0a1":'').' L_%l/%L:%c%V |'
