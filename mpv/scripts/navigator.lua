...
local settings = {
  ...
  --navigator_mainkey = "SHIFT+ENTER", --the key to bring up navigator's menu, can be bound on input.conf aswell
  navigator_mainkey = "TAB", --the key to bring up navigator's menu, can be bound on input.conf aswell
